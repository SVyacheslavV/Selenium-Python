...
with webdriver.Chrome() as browser:  # Инициализация и запуск браузера в конструкции with
    browser.get('https://parsinger.ru/selenium/5.10/2/index.html')  # Открываем страницу
    ...
    for i in range(1, 11):
        ...
        element = browser.find_element(By.ID, f'draganddrop{i}')
    ...
    # скролим экран до появления окна с паролем
